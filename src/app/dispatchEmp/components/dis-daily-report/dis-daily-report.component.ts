...
@Component({
  ...
  templateUrl: './dis-daily-report.component.html',
  styleUrl: './dis-daily-report.component.css'
})
export class DisDailyReportComponent {
  ...
  onSubmit() {
   ...
   // const fromDate = this.datePipe.transform(formData.fromDate, 'yyyy-MM-dd')!;
    ...
    this. reportsService.getDisHistoryByDaily(formData.parcelType)
      .subscribe(
        data => {
